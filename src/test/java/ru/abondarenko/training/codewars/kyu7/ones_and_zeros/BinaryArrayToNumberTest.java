package ru.abondarenko.training.codewars.kyu7.ones_and_zeros;
...
public class BinaryArrayToNumberTest {
    ...
    public void convertBinaryArrayToInt() throws Exception {
        ...
        assertEquals(127, BinaryArrayToNumber.ConvertBinaryArrayToInt(new ArrayList<>(Arrays.asList(1,1,1,1,1,1,1))));
    }
}